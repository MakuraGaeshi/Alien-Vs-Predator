...
namespace RimWorld
{
    ...
    public class IncidentWorker_XenomorphHive : IncidentWorker
    {
		...
		{
			Map map = (Map)parms.target;
			int hivelikeCount = Mathf.Max(GenMath.RoundRandom(parms.points / 50f), 1);
        ...
        {;
            ...
            IncidentWorker_XenomorphHive.SpawnItemInstantly(hivelike);
            for (int i = 0; i < hiveCount - 1; i++)
            {
                ...
                {
                    IncidentWorker_XenomorphHive.SpawnItemInstantly(hivelike2);
                    hivelike = hivelike2;
                }
            }
            return hivelike;
